...
//	NSData *base64data=[data base64EncodedDataWithOptions: NSDataBase64Encoding64CharacterLineLength];
	//filename=[[NSString alloc] initWithData:base64data encoding:NSUTF8StringEncoding];
	
	
	NSString * encodingString = [filename stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];//编码
	filename=encodingString;
	
	NSString *str = [filename stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding];//解码
